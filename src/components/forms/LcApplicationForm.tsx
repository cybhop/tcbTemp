...
interface Props {
  title?: string;
  subtitle?: string;
  defaultLcType?: string;
}

export const LcApplicationForm = ({ 
  title = "Letter of Credit Application", 
  subtitle = "Please complete this form to initiate your Letter of Credit application. All fields marked with * are required.",
  defaultLcType = "Sight"
}: Props) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData(prev => ({
        ...
        countryOfOrigin: "",
        priceTerms: "",
        // RESET: further shipping/banking details
        confirmingBankName: "",
        confirmingBankSwift: "",
        consigneeName: "",
        notifyParty: "",
        ...
        insuranceCoveragePercent: "",
        portOfFinalDestination: "",
        // RESET: commercial/charges meta
        chargesBorneBy: "Applicant",
        availability: "By Payment",
        availableWith: "Any Bank",
        placeOfExpiry: "",
        // RESET: SBLC specifics
  ...
  return (
    <div className="bg-card border border-border rounded-lg p-6 md:p-8 max-w-4xl mx-auto">
      <div className="mb-6">
